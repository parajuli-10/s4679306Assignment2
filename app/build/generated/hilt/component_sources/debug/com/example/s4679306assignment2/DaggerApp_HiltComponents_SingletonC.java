...
import com.example.s4679306assignment2.di.NetworkModule_ProvideApiFactory;
import com.example.s4679306assignment2.di.NetworkModule_ProvideMoshiFactory;
import com.example.s4679306assignment2.di.NetworkModule_ProvideOkHttpFactory;
import com.example.s4679306assignment2.di.NetworkModule_ProvideRepositoryFactory;
import com.example.s4679306assignment2.di.NetworkModule_ProvideRetrofitFactory;
import com.example.s4679306assignment2.ui.dashboard.DashboardActivity;
import com.example.s4679306assignment2.ui.dashboard.DashboardViewModel;
import com.example.s4679306assignment2.ui.dashboard.DashboardViewModel_HiltModules;
import com.example.s4679306assignment2.ui.login.LoginActivity;
import com.example.s4679306assignment2.ui.login.LoginViewModel;
import com.example.s4679306assignment2.ui.login.LoginViewModel_HiltModules;
...
public final class DaggerApp_HiltComponents_SingletonC {
  ...
  private static final class ActivityCImpl extends App_HiltComponents.ActivityC {
    ...
    public Map<Class<?>, Boolean> getViewModelKeys() {
      return LazyClassKeyMap.<Boolean>of(MapBuilder.<String, Boolean>newMapBuilder(2).put(LazyClassKeyProvider.com_example_s4679306assignment2_ui_dashboard_DashboardViewModel, DashboardViewModel_HiltModules.KeyModule.provide()).put(LazyClassKeyProvider.com_example_s4679306assignment2_ui_login_LoginViewModel, LoginViewModel_HiltModules.KeyModule.provide()).build());
    }
  ...
  private static final class ViewModelCImpl extends App_HiltComponents.ViewModelC {
    ...
    public Map<Class<?>, javax.inject.Provider<ViewModel>> getHiltViewModelMap() {
      return LazyClassKeyMap.<javax.inject.Provider<ViewModel>>of(MapBuilder.<String, javax.inject.Provider<ViewModel>>newMapBuilder(2).put(LazyClassKeyProvider.com_example_s4679306assignment2_ui_dashboard_DashboardViewModel, ((Provider) dashboardViewModelProvider)).put(LazyClassKeyProvider.com_example_s4679306assignment2_ui_login_LoginViewModel, ((Provider) loginViewModelProvider)).build());
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.example.s4679306assignment2.ui.dashboard.DashboardViewModel 
          return (T) new DashboardViewModel(singletonCImpl.provideRepositoryProvider.get());

          case 1: // com.example.s4679306assignment2.ui.login.LoginViewModel 
  ...
  private static final class SingletonCImpl extends App_HiltComponents.SingletonC {
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.example.s4679306assignment2.data.Repository 
          return (T) NetworkModule_ProvideRepositoryFactory.provideRepository(singletonCImpl.provideApiProvider.get());

          case 1: // com.example.s4679306assignment2.data.remote.ApiService 
