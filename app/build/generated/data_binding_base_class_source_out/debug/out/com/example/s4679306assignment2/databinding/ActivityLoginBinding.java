...
public final class ActivityLoginBinding implements ViewBinding {
  ...
  private ActivityLoginBinding(@NonNull ConstraintLayout rootView, @NonNull MaterialButton btnLogin,
      ...
      @NonNull FrameLayout loadingOverlay, @NonNull TextInputLayout tilPassword,
      @NonNull TextInputLayout tilUsername, @NonNull TextView tvError, @NonNull TextView tvTitle) {
  ...
  public static ActivityLoginBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityLoginBinding((ConstraintLayout) rootView, btnLogin, etPassword, etUsername,
          loadingOverlay, tilPassword, tilUsername, tvError, tvTitle);
    }
